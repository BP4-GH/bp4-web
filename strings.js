...
window.BP = {
  es: {
    ...
    hero: {
      ...
      v1: {
        kicker: "Incorporar talento es fácil. Sostenerlo es lo difícil.",
        title1: "Más que staff augmentation:",
        titleEm: "gestionamos tu talento tech de punta a punta",
        body: "Reclutamos, cuidamos, medimos y desarrollamos a tu equipo de tecnología. No solo cubrimos posiciones — construimos operaciones sostenibles que rinden en el tiempo.",
      },
      // V3 — momento de marca oscuro
      v3: {
        kicker: "Somos IT — gestionamos equipos críticos",
        title1: "Equipos tech que",
        titleEm: "permanecen, evolucionan y rinden",
  ...
  en: {
    ...
    hero: {
      ...
      v1: {
        kicker: "Hiring talent is easy. Sustaining it is the hard part.",
        title1: "More than staff augmentation:",
        titleEm: "we manage your tech talent end to end",
        body: "We recruit, care for, measure and develop your technology team. We don't just fill roles — we build sustainable operations that perform over time.",
      },
      v3: {
        kicker: "We're IT — we manage critical teams",
        title1: "Tech teams that",
        titleEm: "stay, evolve and perform",
